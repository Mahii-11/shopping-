import { Check, ChevronDown, SlidersHorizontal, X, ShoppingCart, Zap } from "lucide-react";
...
export default function ShopPage() {
  ...
  // Helper for safe product detail path
  ...
  const removeFilter = (type, id) => {
    ...
    if (type === "brand") {
      setActiveBrands((prev) => prev.filter((item) => item !== id));
    }
        ...
        >
          <div className="space-y-8 lg:max-h-[calc(100vh-2rem)] lg:overflow-y-auto lg:pr-2 hide-scrollbar">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {brands.map((brand) => (
                  <li key={brand.id} className="flex items-center text-sm">
                    <button
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                {colors.map((col) => (
                  <li key={col.id} className="flex items-center text-sm">
                    <button
                ...
                <div className="flex-1 flex flex-wrap items-center gap-2 md:justify-center">
                  ...
                  {filters.map((item) => (
                    ...
                    >
                      {item.label}
                      <button
                        onClick={() => removeFilter(item.type, item.id)}
                  ...
                  products.map((product) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <Link
                          to={productPath}
                          className="relative aspect-square overflow-hidden bg-[#f3f4f6] block"
                        >
                        ...
                        <div className="flex flex-1 flex-col gap-1 border-t border-gray-100 p-3 sm:gap-1.5 sm:p-4">
                          ...
                          <div className="mt-1 flex items-baseline gap-1.5 pb-2">
                          ...
                          <div className="mt-auto flex flex-col gap-2 pt-2">
                            <button
                              ...
                              className="flex w-full items-center justify-center gap-1.5 rounded-md border border-gray-300 bg-white py-2 text-xs font-semibold text-gray-800 transition-all duration-200 hover:border-orange-600 hover:bg-orange-50 hover:text-orange-600 sm:text-sm cursor-pointer"
                            >
                            ...
                            <button
                              ...
                              className="flex w-full items-center justify-center gap-1.5 rounded-md bg-black py-2 text-xs font-semibold text-white transition-all duration-200 hover:bg-orange-600 sm:text-sm cursor-pointer"
                            >
